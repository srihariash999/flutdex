      ...
      children: [
        ...
        Consumer(
          builder: (context, ref, child) {
            print("Grid rebuilt");
            var _pokemonsList = ref.watch(
                homeScreenViewController.select((state) => state.pokemons));
            return Expanded(
              child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    Pokemon _pokemon = _pokemonsList[index];
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
        ...
        Consumer(
          builder: (context, ref, child) {
            ...
            var _isLoadMoreLoading = ref.watch(homeScreenViewController
                .select((state) => state.isLoadMoreLoading));
            return Column(
              children: [
                Row(
